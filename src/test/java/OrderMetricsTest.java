...
public class OrderMetricsTest {
  ...
  void setUp () throws Exception {
    ...
    Object order9 = createOrder ("9" , LocalDateTime.now () , customer2 ,
        List.of (orderItem1 , orderItem2) , statuses[0]);
    Object order10 = createOrder ("10" , LocalDateTime.now () , customer3 , List.of (orderItem5) ,
        statuses[4]);
    Object order11 = createOrder ("11" , LocalDateTime.now () , customer3 , List.of (orderItem3) ,
        statuses[2]);
    Object order12 = createOrder ("12" , LocalDateTime.now () , customer1 , List.of (orderItem5) ,
        statuses[3]);
    Object order13 = createOrder ("13" , LocalDateTime.now () , customer4 , List.of (orderItem2) ,
        statuses[4]);
    Object order14 = createOrder ("14" , LocalDateTime.now () , customer5 , List.of (orderItem3) ,
        statuses[2]);
    Object order15 = createOrder ("15" , LocalDateTime.now () , customer6 , List.of (orderItem4) ,
        statuses[3]);
    Object order16 = createOrder ("16" , LocalDateTime.now () , customer7 , List.of (orderItem2) ,
        statuses[4]);
    Object order17 = createOrder ("17" , LocalDateTime.now () , customer8 , List.of (orderItem3) ,
        statuses[2]);
    Object order18 = createOrder ("18" , LocalDateTime.now () , customer9 , List.of (orderItem4) ,
        statuses[3]);
    Object order19 = createOrder ("19" , LocalDateTime.now () , customer10 , List.of (orderItem2) ,
        statuses[4]);
    Object order20 = createOrder ("20" , LocalDateTime.now () , customer1 , List.of (orderItem3) ,
        statuses[2]);
    Object order21 = createOrder ("21" , LocalDateTime.now () , customer1 , List.of (orderItem4) ,
        statuses[3]);
    Object order22 = createOrder ("22" , LocalDateTime.now () , customer1 , List.of (orderItem2) ,
        statuses[3]);
    Object order23 = createOrder ("23" , LocalDateTime.now () , customer2 , List.of (orderItem3) ,
        statuses[3]);
    Object order24 = createOrder ("24" , LocalDateTime.now () , customer2 , List.of (orderItem4) ,
        statuses[4]);
    Object order25 = createOrder ("25" , LocalDateTime.now () , customer2 , List.of (orderItem2) ,
        statuses[4]);
    Object order26 = createOrder ("26" , LocalDateTime.now () , customer3 , List.of (orderItem3) ,
        statuses[4]);
    Object order27 = createOrder ("27" , LocalDateTime.now () , customer3 , List.of (orderItem4) ,
        statuses[4]);
    Object order28 = createOrder ("28" , LocalDateTime.now () , customer3 , List.of (orderItem2) ,
        statuses[4]);
    Object order29 = createOrder ("29" , LocalDateTime.now () , customer4 , List.of (orderItem3) ,
        statuses[4]);
    Object order30 = createOrder ("30" , LocalDateTime.now () , customer4 , List.of (orderItem4) ,
        statuses[4]);
    ...
    List <Object> extraList = List.of (order12 , order13 , order14 , order15 , order16 , order17 ,
    ...
    List <Object> extraList2 = List.of (order23 , order24 , order25 , order26 , order27 , order28 ,
        order29 , order30);
